...
def parse_args():
    ...
    # Pruning config
    parser.add_argument("--pruningmode",default='low_magnitude' , help='pruning mode low magnitude/random/high magnitude pruning')
    parser.add_argument("--sparsity",  dest='sparsity', default=10 , help='value in range 10 to 90 percent')
    parser.add_argument("--pruning", action='store_const', default=False, const=True)
